...
function iis_start_assets() {
	wp_enqueue_style( 'iis-start-style', get_stylesheet_directory_uri() . iis_start_mix('css/site.css'), [], false );
	wp_enqueue_script( 'iis-start-script', get_stylesheet_directory_uri() . iis_start_mix('js/site.js'), [], false, true );
}
